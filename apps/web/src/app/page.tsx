        ...
        <div className="container relative mx-auto max-w-6xl px-4 py-8 sm:py-14">
          <div className="grid gap-6 lg:grid-cols-[1.1fr_0.9fr] lg:items-center">
            <div>
              ...
              <h1 className="text-3xl font-semibold tracking-tight text-amber-50 sm:text-5xl">
                Save for a goal. Break early and <span className="text-amber-400">pay for it</span>.
              </h1>
              <p className="mt-4 max-w-2xl text-sm leading-7 text-amber-100/70 sm:text-lg">
                MiniSave is a MiniPay-native savings vault on Celo. Lock money toward a target, stay disciplined, and track the full journey onchain.
              </p>
            ...
            <div className="rounded-[30px] border border-amber-500/15 bg-[#0f0c08]/90 p-5 shadow-[0_0_60px_rgba(0,0,0,0.18)] sm:p-6">
